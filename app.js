...
function setCollapsedCategories(arr) {const guideListEl = document.getElementById("guide-list");
const contentEl = document.getElementById("content");
const searchEl = document.getElementById("search");
const themeToggle = document.getElementById("theme-toggle");
  ...
  return `
    <div class="guide-info-wrapper">
      ...
      <aside class="guide-infobox">
        ...
        ${meta.chapter ? `<div><strong>Chapter</strong> ${meta.chapter}</div>` : ""}
        ${meta.section ? `<div><strong>Section</strong> ${meta.section}</div>` : ""}
...
// Convertssss relative path to raw GitHub URL
